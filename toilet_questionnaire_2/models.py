...
class Player(BasePlayer):
    ...
    q2_fair_discussion = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_fear_criticism = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_communication_to_be_right = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_give_opinion = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_others_opinions = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_communication_whine = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_inputs_considered = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_best_player = models.CharField(max_length=255, widget=widgets.RadioSelect(),choices=[])
    q2_communication_focused = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_communication_efficient = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    ...
    q2_discussion_tense = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_discussion_tense_why = models.TextField()
    q2_chat_instructions_helpful = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_chat_instructions_followed = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    ...
    # confidant
    q2_confidant_followed_chat_intstructions = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_difficulty_chat_instructions = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_problems_chat_instructions = models.TextField()
    q2_confidant_others_found_out_confidant = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_others_found_out_confidant_why = models.TextField()
    q2_confidant_pleased_about_being_chosen = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_would_have_participated_if_knew = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_comments_in_general = models.TextField()
    q2_confidant_influence_inputs = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
    q2_confidant_inputs_being_ignored_others = models.PositiveIntegerField(min=1, max=5, widget=widgets.SliderInput(show_value=False))
